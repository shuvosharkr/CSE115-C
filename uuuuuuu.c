...
void data_entry( )
{
    f=fopen("F:\\project\\student data again.txt","a");
    int i;
    for(i=0; i<5; i++)
        {
            printf("Enter name: ");
...
int main ( )
{
    ...
    {
        printf("Right pass!");
        fRe=fopen("E:\\file learning\\student data again.txt","r");
